...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   ...
   <div class="row">
      ...
      <div class="col-xl-4 col-md-6 mb-4">
         <div class="card border-primary shadow h-100 py-2" style="background-color: red; color:white; font-size:1.5rem">
            <div class="card-body">
               <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                     <div class="text-xs font-weight-bold text-uppercase mb-1">Montant total des dettes</div>
                     <div class="h5 mb-0 font-weight-bold ">
                        {{number_format($totalDette,2,'.',' ')}} DA <br />
                     </div>
                  </div>
                  <div class="col-auto">
                     <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
