...
@section('content')
      <div class="row">
         ...
         <div class="card col-lg-8 card-default d-flex justify-content-center">
            <div class="card-header mb-0 pb-0">
                <h4  style="font-weight: 700; color:black">{{isset($employe) ? 'Mettre à jour les informations du l' : 'Ajouter un'}} employe</h4>
            </div>
            <div class="card-body">
